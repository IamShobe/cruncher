...
<div class="not-content" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 1rem; margin: 1.5rem 0;">
  ...
  <AdapterCard
    name="Datadog"
    type="datadog"
    description="Query logs from the Datadog observability platform using browser-session authentication. Supports index filtering, facet autocomplete, and live mode."
    link="/adapters/datadog"
    icon="🐶"
  />
  <AdapterCard
    name="Mocked Data"
