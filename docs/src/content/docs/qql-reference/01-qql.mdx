  ...
  steps={[
    ...
    },
    {
      ...
      stages: [
        {
          label: "Filter & Select",
          description: "where — filter records by condition",
          icon: "🔽"
        },
        {
          label: "Transform",
          description: "eval, regex — create or modify fields",
          icon: "🔄"
        },
        {
          label: "Aggregate",
          description: "stats, timechart — summarize data",
          icon: "📊"
        }
      ]
    },
...
| `sort` | Sort by field | `sort timestamp desc` |
