...
export const selectedSearchProfileAtom = atom((get) => {
    ...
    if (
        ...
        selectedProfileIndex >= searchProfiles.length
    ) {
        return undefined;
    }
...
const controllerParamsAtom = atom(async (get) => {
    ...
    if (
        ...
        selectedInstanceIndex >= supportedProfiles.length
    ) {
        return {};
    }
...
export const isHeaderOpenAtom = atom(true);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    awaitableJob = await controller.query(
